<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin.Master" CodeBehind="adminAccount.aspx.cs" Inherits="testmain.acount" %>
  ...
  <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
						    ...
						    <div class="app-card-footer p-4 mt-auto">
							   <asp:LinkButton runat="server" ID="btnsave" OnClick="btnsave_Click" CssClass="btn app-btn-secondary" Visible="false">Save Profile</asp:LinkButton>
								<asp:LinkButton runat="server" ID="btncancel" href="adminAccount.aspx" CssClass="btn app-btn-secondary" Visible="false">Cancel</asp:LinkButton>
						    </div><!--//app-card-footer-->
